...
abbr gfrm 'git pull --rebase origin master'
# Index (i)
abbr gia 'git add'
...
abbr gris 'git rebase --interactive --autosquash HEAD~3'
...
abbr gwx 'git rm -r'
abbr gwX 'git rm -rf'
abbr gfrf 'git fetch; and git reset --hard origin/(git-branch-current 2> /dev/null)'
